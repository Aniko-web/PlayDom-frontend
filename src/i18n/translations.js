...
export const TRANSLATIONS = {
  uz: {
    ...
    auth: {
      ...
      titleLogin: "Hisobingizga kiring",
      titleRegister: "Ro'yxatdan o'tish",
      subtitleLogin: "Xaridlarni amalga oshirish va buyurtmalarni kuzatish uchun kiring",
      subtitleRegister: "Playdom imkoniyatlaridan to'liq foydalanish uchun hisob yarating",
      firstName: "Ism",
      firstNamePlaceholder: "Ismingiz",
      lastName: "Familiya",
      lastNamePlaceholder: "Familiyangiz (ixtiyoriy)",
      email: "Email",
      emailPlaceholder: "example@mail.com",
      loginOrEmail: "Login yoki email",
      loginOrEmailPlaceholder: "Email manzilingiz",
      password: "Parol",
      ...
      consentMiddle: " va ",
      privacy: "maxfiylik siyosati",
      consentSuffix: " shartlariga roziman",
      consentFull: "Ommaviy oferta va maxfiylik siyosati shartlariga roziman",
      pleaseWait: "Iltimos, kuting...",
      noAccount: "Hisobingiz yo'qmi?",
      haveAccount: "Akkauntingiz bormi?",
      forgotPassword: "Parolni unutdingizmi?",
      loginSuccess: "Xush kelibsiz! Muvaffaqiyatli kirdingiz.",
      registerSuccess: "Tabriklaymiz! Muvaffaqiyatli ro'yxatdan o'tdingiz.",
  ...
  ru: {
    ...
    auth: {
      ...
      subtitleLogin: "Войдите для совершения покупок и отслеживания заказов",
      subtitleRegister: "Создайте аккаунт, чтобы использовать все возможности Playdom",
      firstName: "Имя",
      firstNamePlaceholder: "Ваше имя",
      lastName: "Фамилия",
      lastNamePlaceholder: "Ваша фамилия (необязательно)",
      email: "Email",
      emailPlaceholder: "example@mail.com",
      loginOrEmail: "Логин или email",
      loginOrEmailPlaceholder: "Ваш email",
      password: "Пароль",
      ...
      consentSuffix: "",
      consentFull: "Согласен с офертой и политикой конфиденциальности",
      pleaseWait: "Пожалуйста, подождите...",
      noAccount: "Нет аккаунта?",
      haveAccount: "Уже есть аккаунт?",
      forgotPassword: "Забыли пароль?",
      loginSuccess: "Добро пожаловать! Вы успешно вошли.",
      registerSuccess: "Поздравляем! Вы успешно зарегистрировались.",
      loginError: "Неверный email или пароль",
      consentRequired: "Для регистрации необходимо согласиться с условиями",
